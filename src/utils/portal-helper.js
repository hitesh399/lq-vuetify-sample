...
function portal(portalName) {
    ...
    this.getAssetsUrl = function () {
        return this.configs.VUE_APP_ASSETS_URL ? this.configs.VUE_APP_ASSETS_URL : this.configs.VUE_APP_DOMAIN_PREFIX;
    }
    ...
    this.getLandingUrl = function (login_index, uri) {
        return login_index && this.isMultiLogin() ? this.getPortalUrl('u/' + login_index) : this.getPortalUrl(uri);
    }
...
const currentPortal = new portal(process.env.VUE_APP_PORTAL_NAME);
module.exports = {
